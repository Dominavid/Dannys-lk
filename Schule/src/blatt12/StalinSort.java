...
public class StalinSort {
    ...
    public static Integer[] stalinSortNull(Integer[] arr) {
        int x = 1;
    ...
    public static Integer[] zuInteger(int[] arr) {
        Integer[] zarr = new Integer[arr.length];
    ...
    public static void main(String[] args) {
        ...
        //blatt07.ArbeitMitArrays.printArray(stalinSort(sukablyad));
        Integer[] stalinArray = stalinSortNull(zuInteger(sukablyad));
        for (int i = 0; i < stalinArray.length; i++) {
            System.out.print(stalinArray[i] + "\t");
        }
        int volksgenossen = 0;
        int kapitalisten = 0;
        for (int i = 0; i < stalinArray.length; i++) {
            if (stalinArray[i] != null) {
                volksgenossen++;
            } else {
                kapitalisten++;
            }
        }
        System.out.println("\n\nfleißige Volksgenossen:\t\t\t\t\t\t" + volksgenossen);
        System.out.println("Kapitalistenschweine und Volksverräter:\t\t" + kapitalisten);
    }
}
